...
The RPIM package will allow you to calculate an epigenetic heterogeneity score from DNA methylation data. The score is called PIM, or *Proportion of sites with Intermediate Methylation*.
